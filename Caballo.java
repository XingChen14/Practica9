public class Caballo extends MedioDeTransporteAnimal {
    ...
    @Override
    public void avanzar() {
        System.out.println("El caballo está avanzando en el campo.");
    }

    @Override
    public void retroceder() {
        System.out.println("El caballo está retrocediendo.");
    }

    @Override
    public void virar() {
        System.out.println("El caballo está tomando una curva.");
    }
}
